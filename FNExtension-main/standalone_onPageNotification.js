...
// Keep your local path for reference
const localSoundPath = 'D:/Codebase/FNExtension-main/FNExtension-main/chrome-extension/sounds/button-44.mp3';

// Preload the sound in JavaScript only when running as a Chrome extension
const soundUrl = (window.chrome && chrome.runtime && typeof chrome.runtime.getURL === 'function')
  ? chrome.runtime.getURL('sounds/button-44.mp3')
  : null;

const sound = soundUrl ? new Audio(soundUrl) : null;
if (sound) {
  sound.preload = 'auto';
}
